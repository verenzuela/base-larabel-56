@extends('layouts.admin.master', 
  ['locale'       => '',
   'bodyCss'      => '',
   'title'        => strtoupper(env('APP_NAME')).' | '.__('admin.customers.label'),
   'ogTitle'      => '',
   'ogLocale'     => '',
   'ogDescription'=> '',
   'ogUrl'        => '',
            ...
            <div class="page-inner mt-2 pt-0 ">
              <header class="page-title-bar m-0 p-0 ">
                ...
                @permission('members-create')
                  <a href="{{ route('user.type.create', ['userType'=>'frontend'] ) }}" class="btn btn-success btn-floated pt-3"><span class="fa fa-plus"></span></a>
                @endpermission

                <!-- title and toolbar -->
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto">{{ __('admin.customers.label') }}</h1>
                </div>
                            ...
                            @foreach ($users as $user)
                              ...
                              <tr>
                                ...
                                <td class="align-middle">
                                  {!! ( count($user->roles) != 0 ) ? __('admin.'.$user->roles[0]->name) : __('admin.label.noRoleSet') !!}
                                </td>
